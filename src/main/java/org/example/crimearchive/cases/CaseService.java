...
import org.example.crimearchive.permissions.RedactedAuthzDeniedHandler;
...
public class CaseService {
    ...
    //@PreAuthorize("@caseSecurity.canAccessCase(casenumber, principal.username)")
    //@HandleAuthorizationDenied(handlerClass = RedactedAuthzDeniedHandler.class)
